...
Чтобы понимать, как работают нейросети, PyTorch и LLM, нужно знать математику **под капотом**. Этот курс проходит Phase 1-18 курса [AI Engineering from Scratch](https://aiengineeringfromscratch.com/):
